    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_sign_out.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AuthUI.getInstance().signOut(SignUpTestActivity.this).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(SignUpTestActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT);
                    }
                });
            }
        });
